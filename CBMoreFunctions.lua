...
function main()
 ...
 if version ~= data['aversion'] then sampAddChatMessage("[SERVER]: {FFFFFF}У вас установлена устареля версия скрипта CBMoreFunctions. Пожалуйста, обновите её!",COLOR_MSG) end
